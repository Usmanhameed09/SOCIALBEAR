      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-surface-500 text-sm mt-1">
            Configure moderation thresholds, categories, and API access
          </p>
        </div>
        <button
          onClick={saveConfig}
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-surface-200/80 p-6">
          ...
          <p className="text-xs text-surface-400 mb-4">
            Used server-side for content classification. Never exposed to the
            extension.
          </p>
        ...
        <div className="bg-white rounded-2xl border border-surface-200/80 p-6">
          ...
          <p className="text-xs text-surface-400 mb-4">
            GPT-4o is more accurate for nuanced categories. GPT-4o-mini is faster and cheaper.
          </p>
          <select
        ...
        <div className="bg-white rounded-2xl border border-surface-200/80 p-6">
          ...
          <p className="text-xs text-surface-400 mb-4">
            Messages scoring above this threshold will trigger the configured
            action.
          </p>
        ...
        <div className="bg-white rounded-2xl border border-surface-200/80 p-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-surface-400">
                    Automatically hide messages meeting threshold
                  </p>
                </div>
              </div>
              <button
                ...
                className={clsx(
                  "toggle-switch",
                  config.auto_hide_enabled && "active"
                )}
              />
            </div>
            ...
            <div className="flex items-center justify-between py-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-surface-400">
                    Classify and badge only — no auto-hide actions
                  </p>
                </div>
              </div>
              <button
          ...
          {config.dry_run_mode && (
            <div className="mt-4 p-3 bg-warning-50 border border-warning-100 rounded-xl flex items-center gap-2">
              <AlertTriangle className="w-4 h-4 text-warning-500 flex-shrink-0" />
              <p className="text-xs text-warning-700">
                Dry-run is active. Messages will be classified and badged but
                not auto-hidden.
              </p>
            </div>
          )}
        ...
        {/* Categories — now managed in dedicated page */}
        <div className="bg-white rounded-2xl border border-surface-200/80 p-6">
          ...
          <p className="text-xs text-surface-400 mb-4">
            Categories are now managed with custom AI prompts for each. Includes all client-specified categories across General, Food & Health, Lifestyle, and Parenting brands.
          </p>
          <a
